		...
		case 7:
			...
			while(choice<=6) {
				...
				while (choice!=0 && choice<=6) {
					...
					if(choice==2) {System.out.println("Powers");
					...
					if(choice==3) {System.out.println("Square roots");
					System.out.println("Enter a Number");
					double number7=input.nextDouble();
					...
					if(choice==4) {System.out.println("Round up");
					System.out.println("Enter a Number");
					double number7=input.nextDouble();
					...
					if(choice==5) {System.out.println("Round down");
					System.out.println("Enter a Number");
					double number7=input.nextDouble();
					...
					if(choice==6) {System.out.println("Quitting");
					choice=7;
					}
				}
